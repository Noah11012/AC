...
{ // beware: sound order is part of the game protocol
    ...
    S_PAIN4,
    S_PAIN5,
    S_PAIN6, // S_PAIN2..S_PAIN5 are hardcoded S_PAIN1+1..S_PAIN1+4
    S_DIE1,
    S_DIE2,
    S_FEXPLODE,
    S_SPLASH1,
    ...
    S_FOOTSTEPSCROUCH,
    S_WATERFOOTSTEPS,
    S_WATERFOOTSTEPSCROUCH, // hardcoded S_FOOTSTEPS+0..S_FOOTSTEPS+3
    S_CROUCH,
    S_UNCROUCH,
    S_MENUSELECT,
    S_MENUENTER,
...
#define gamesound_ispublicvoicecom(x) \
    gamesound_hasflag (x, 1 << SC_PUBLIC) // voicecoms always sent to all players
