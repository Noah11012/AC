...
#define MAXMEDIADOWNLOADFILESIZE \
    1024000 // hard cap on filesizes (raw and unzipped) - to limit the effect of
            // zip bombs - no nice error messages: just cap
#define MAXMODDOWNLOADSIZE \
    1024000                // hard cap on the filesize of downloaded mod packages - to keep
                           // stuff reasonable
...
enum
{
    ...
    SP_SPECT,
    SP_NUM
}; // spawn permission (<OK_NUM && isspect: change to active team allowed)
enum
{
    HE_COMBO,
    HE_COMBO2,
...
enum
{
    ...
    GMMASK__BOT = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS | GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY
                  | GMMASK_BOTTEAMDEATHMATCH | GMMASK_BOTTEAMONESHOTONKILL | GMMASK_BOTTEAMSURVIVOR,
    GMMASK__MP = GMMASK_TEAMDEATHMATCH | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR
                 | GMMASK_TEAMSURVIVOR | GMMASK_CTF | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING
                 | GMMASK_ONESHOTONEKILL | GMMASK_TEAMONESHOTONEKILL | GMMASK_HUNTTHEFLAG
                 | GMMASK_TEAMKEEPTHEFLAG | GMMASK_KEEPTHEFLAG | GMMASK_TEAMPF | GMMASK_TEAMLSS,
    GMMASK__MPNOCOOP = GMMASK__MP & ~GMMASK_COOPEDIT,
    GMMASK__TEAM = GMMASK_BOTTEAMDEATHMATCH | GMMASK_BOTTEAMONESHOTONKILL | GMMASK_BOTTEAMSURVIVOR
                   | GMMASK_TEAMDEATHMATCH | GMMASK_TEAMSURVIVOR | GMMASK_CTF | GMMASK_TEAMONESHOTONEKILL
                   | GMMASK_HUNTTHEFLAG | GMMASK_TEAMKEEPTHEFLAG | GMMASK_TEAMPF | GMMASK_TEAMLSS,
    GMMASK__TEAMSPAWN = GMMASK_BOTTEAMDEATHMATCH | GMMASK_BOTTEAMONESHOTONKILL | GMMASK_BOTTEAMSURVIVOR
                        | GMMASK_TEAMDEATHMATCH | GMMASK_TEAMSURVIVOR | GMMASK_CTF | GMMASK_TEAMONESHOTONEKILL
                        | GMMASK_HUNTTHEFLAG | GMMASK_TEAMPF | GMMASK_TEAMLSS,
    GMMASK__FFA = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS | GMMASK_BOTONESHOTONEKILL | GMMASK_BOTPISTOLFRENZY
                  | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR | GMMASK_PISTOLFRENZY
                  | GMMASK_LASTSWISSSTANDING | GMMASK_ONESHOTONEKILL | GMMASK_KEEPTHEFLAG,
    GMMASK__FFASPAWN = GMMASK_BOTDEATHMATCH | GMMASK_BOTLSS | GMMASK_BOTONESHOTONEKILL
                       | GMMASK_BOTPISTOLFRENZY | GMMASK_COOPEDIT | GMMASK_DEATHMATCH | GMMASK_SURVIVOR
                       | GMMASK_PISTOLFRENZY | GMMASK_LASTSWISSSTANDING | GMMASK_ONESHOTONEKILL
                       | GMMASK_KEEPTHEFLAG | GMMASK_KEEPTHEFLAG | GMMASK_TEAMKEEPTHEFLAG
};
...
#define m_autospawn \
    (gamemode == 0 || gamemode == 2 || gamemode == 6 || gamemode == 13 || gamemode == 16)
#define m_teammode                                                                                        \
    (gamemode == 0 || gamemode == 4 || gamemode == 5 || gamemode == 7 || gamemode == 11 || gamemode == 13 \
     || gamemode == 14 || gamemode == 16 || gamemode == 17 || gamemode == 20 || gamemode == 21)
#define m_tarena (m_arena && m_teammode)
#define m_botmode \
    (gamemode == 7 || gamemode == 8 || gamemode == 12 || (gamemode >= 18 && gamemode <= 21))
#define m_valid(mode) (((mode) >= 0 && (mode) < GMODE_NUM) || (mode) == -1)
#define m_mp(mode)                                                               \
    (m_valid (mode) && (mode) >= 0 && (mode) != 7 && (mode) != 8 && (mode) != 12 \
     && ((mode) < 18 || (mode) > 21))
...
#define FTXT__MDLATTR \
    (FTXT_NOWHITE | FTXT_ALLOWBLANKS | FTXT_TABTOBLANK | FTXT_NOCOLOR | FTXT_SAFECS)
